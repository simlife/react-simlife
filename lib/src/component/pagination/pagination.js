...
var SimPagination = /** @class */ (function (_super) {
    __extends(SimPagination, _super);
    function SimPagination(props) {
    ...
    SimPagination.prototype.render = function () {
        var _this = this;
    ...
    return SimPagination;
}(React.Component));
exports.SimPagination = SimPagination;
