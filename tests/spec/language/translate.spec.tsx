...
import { Translate, translate, TranslatorContext } from '../../../react-simlife';
...
TranslatorContext.registerTranslations('en', {
  foo: {
    ...
    'baz.foo': 'dirty key',
    foozfooz: 'simlife is <strong>awesome</strong>!'
  }
});
...
describe('translate service', () => {
  ...
  it('produce translated React component', () => {
    ...
    const span = mountedWrapper.find('span');
    expect(span.length).to.equal(1);
    expect(mountedWrapper.html()).to.equal('<span>simlife is <strong>awesome</strong>!</span>');
  });
});
